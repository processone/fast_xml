...
decode_name_cdata(__TopXMLNS, _val) ->
    try erlang:binary_to_atom(_val, utf8) of
        _res -> _res
    catch
        error:_ ->
            erlang:error({fxmlrpc_codec,
...
decode_data(__TopXMLNS, __Opts,
    ...
    V = decode_data_els(__TopXMLNS, __Opts, _els, []),
    V.
...
decode_array(__TopXMLNS, __Opts,
    ...
    Data = decode_array_els(__TopXMLNS,
                            __Opts,
                            _els,
                            error),
    {array, Data}.
...
decode_boolean(__TopXMLNS, __Opts,
    ...
    Cdata = decode_boolean_els(__TopXMLNS,
                               __Opts,
                               _els,
                               <<>>),
    {boolean, Cdata}.
...
decode_dateTime(__TopXMLNS, __Opts,
    ...
    Cdata = decode_dateTime_els(__TopXMLNS,
                                __Opts,
                                _els,
                                <<>>),
    {date, Cdata}.
...
decode_dateTime_els(__TopXMLNS, __Opts,
                    [{xmlcdata, _data} | _els], Cdata) ->
    decode_dateTime_els(__TopXMLNS,
                        __Opts,
                        _els,
                        <<Cdata/binary, _data/binary>>);
...
decode_base64(__TopXMLNS, __Opts,
    ...
    Cdata = decode_base64_els(__TopXMLNS,
                              __Opts,
                              _els,
                              <<>>),
    {base64, Cdata}.
...
decode_double(__TopXMLNS, __Opts,
    ...
    Cdata = decode_double_els(__TopXMLNS,
                              __Opts,
                              _els,
                              <<>>),
    {double, Cdata}.
...
decode_double_cdata(__TopXMLNS, _val) ->
    try erlang:binary_to_float(_val) of
        _res -> _res
    catch
        error:_ ->
            erlang:error({fxmlrpc_codec,
...
decode_int_cdata(__TopXMLNS, _val) ->
    try erlang:binary_to_integer(_val) of
        _res -> _res
    catch
        error:_ ->
            erlang:error({fxmlrpc_codec,
...
decode_value(__TopXMLNS, __Opts,
    ...
    {Cdata, Val} = decode_value_els(__TopXMLNS,
                                    __Opts,
                                    _els,
                                    <<>>,
                                    undefined),
...
decode_param(__TopXMLNS, __Opts,
    ...
    Value = decode_param_els(__TopXMLNS,
                             __Opts,
                             _els,
                             error),
    Value.
...
decode_params(__TopXMLNS, __Opts,
    ...
    Params = decode_params_els(__TopXMLNS,
                               __Opts,
                               _els,
                               []),
    Params.
...
decode_params_els(__TopXMLNS, __Opts,
    ...
    case fxmlrpc_codec:get_attr(<<"xmlns">>,
        ...
        of
        <<"xmlrpc">> ->
            decode_params_els(__TopXMLNS,
                              __Opts,
                              _els,
                              [decode_param(<<"xmlrpc">>, __Opts, _el)
                               | Params]);
...
decode_methodName(__TopXMLNS, __Opts,
    ...
    Cdata = decode_methodName_els(__TopXMLNS,
                                  __Opts,
                                  _els,
                                  <<>>),
    Cdata.
...
decode_methodName_els(__TopXMLNS, __Opts,
                      [{xmlcdata, _data} | _els], Cdata) ->
    decode_methodName_els(__TopXMLNS,
                          __Opts,
                          _els,
                          <<Cdata/binary, _data/binary>>);
...
decode_fault(__TopXMLNS, __Opts,
    ...
    Value = decode_fault_els(__TopXMLNS,
                             __Opts,
                             _els,
                             error),
    {fault, Value}.
...
decode_methodResponse_els(__TopXMLNS, __Opts,
    ...
    case fxmlrpc_codec:get_attr(<<"xmlns">>,
        ...
        of
        <<"xmlrpc">> ->
            decode_methodResponse_els(__TopXMLNS,
                                      __Opts,
                                      _els,
